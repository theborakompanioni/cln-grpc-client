# Contributing to cln-grpc-client
...
The [issue tracker](https://github.com/theborakompanioni/cln-grpc-client/issues) is
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/cln-grpc-client.git
   # Navigate to the newly cloned directory
   cd cln-grpc-client
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/theborakompanioni/cln-grpc-client.git
   ```
